...
const HeroHomePage = ({ heroApi }) => {
    return (
        <div clasName='relative w-auto h-auto flex  overflow-x-hidden '>
            ...
            <div className=" relative z-20 lg:container md:container container   m-auto border-none sm:pt-[5rem] ">
                ...
                <div className=" grid lg:gap-3 sm:gap-14 max-[800px]:gap-4 ">
                    ...
                    <button type="button" className="hero-home-btn ">{heroApi.btnText}</button>
                ...
                <div className="w-[8rem] grid gap-5 absolute overflow-hidden max-[300px]:gap-2 ">
                    {
